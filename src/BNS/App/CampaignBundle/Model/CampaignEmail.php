 ...
 */
class CampaignEmail extends Campaign {

    /**
     * Constructs a new CampaignEmail class, setting the type column to CampaignPeer::CLASSKEY_2.
     */
    public function __construct()
    {
        parent::__construct();
        $this->setType(CampaignPeer::CLASSKEY_2);
    }
