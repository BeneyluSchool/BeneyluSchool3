...
abstract class MiniSiteWidgetCore extends MiniSiteWidget
{
	...
	/**
	 * @param \BNS\App\CoreBundle\Model\MiniSiteWidget $widget
	 * 
	...
	public static function create(MiniSiteWidget $widget)
	{
		...
		$widgetTemplate->replaceMiniSiteWidgetExtraPropertys($widget->getMiniSiteWidgetExtraPropertys());
		$widgetTemplate->getMiniSiteWidgetTemplate()->setLocale(BNSAccess::getLocale());
