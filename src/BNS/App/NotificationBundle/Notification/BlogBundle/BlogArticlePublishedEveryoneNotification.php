...
/**
 * Notification generation date : 24/10/2012 13:43:35
 */
class BlogArticlePublishedEveryoneNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'BLOG_ARTICLE_PUBLISHED_EVERYONE';
