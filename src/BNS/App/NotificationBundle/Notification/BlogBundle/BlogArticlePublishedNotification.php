...
/**
 * Notification generation date : 29/05/2012 08:53:30 
 */
class BlogArticlePublishedNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'BLOG_ARTICLE_PUBLISHED';
