...
/**
 * Notification generation date : 29/05/2012 08:55:36 
 */
class BlogArticleValidatedNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'BLOG_ARTICLE_VALIDATED';
