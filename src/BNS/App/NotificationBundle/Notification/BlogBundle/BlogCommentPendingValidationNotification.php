...
/**
 * Notification generation date : 28/01/2013 16:38:16
 */
class BlogCommentPendingValidationNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'BLOG_COMMENT_PENDING_VALIDATION';
	...
	public static function translate(Notification $notification, $objects)
	{
		...
		$finalObjects['%comment_route%']	= self::$container->get('cli.router')->generate('blog_manager_article_visualisation', array(
			'articleSlug' => $comment->getObject()->getSlug()
		), true);
