...
/**
 * Notification generation date : 28/01/2013 16:33:47
 */
class BlogCommentPublishedForAuthorNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'BLOG_COMMENT_PUBLISHED_FOR_AUTHOR';
