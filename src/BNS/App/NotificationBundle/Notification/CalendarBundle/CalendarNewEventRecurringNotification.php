...
/**
 * Notification generation date : 04/01/2013 11:20:57
 */
class CalendarNewEventRecurringNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'CALENDAR_NEW_EVENT_RECURRING';
