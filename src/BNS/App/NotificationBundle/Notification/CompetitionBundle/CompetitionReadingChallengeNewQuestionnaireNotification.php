...
/**
 * Notification generation date : 23/06/2017 15:50:10
 */
class CompetitionReadingChallengeNewQuestionnaireNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_READING_CHALLENGE_NEW_QUESTIONNAIRE';
