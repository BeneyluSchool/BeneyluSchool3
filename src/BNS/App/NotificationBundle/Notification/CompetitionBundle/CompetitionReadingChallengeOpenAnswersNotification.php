...
/**
 * Notification generation date : 23/06/2017 15:46:52
 */
class CompetitionReadingChallengeOpenAnswersNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_READING_CHALLENGE_OPEN_ANSWERS';
