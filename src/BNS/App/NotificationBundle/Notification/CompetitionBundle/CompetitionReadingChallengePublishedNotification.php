...
/**
 * Notification generation date : 23/06/2017 15:43:53
 */
class CompetitionReadingChallengePublishedNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_READING_CHALLENGE_PUBLISHED';
