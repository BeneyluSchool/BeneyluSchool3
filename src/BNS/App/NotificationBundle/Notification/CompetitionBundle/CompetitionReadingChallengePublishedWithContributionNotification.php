...
/**
 * Notification generation date : 23/06/2017 15:44:27
 */
class CompetitionReadingChallengePublishedWithContributionNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_READING_CHALLENGE_PUBLISHED_WITH_CONTRIBUTION';
