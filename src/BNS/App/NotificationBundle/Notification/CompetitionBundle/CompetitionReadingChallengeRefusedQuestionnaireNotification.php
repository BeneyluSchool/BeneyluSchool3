...
/**
 * Notification generation date : 23/06/2017 15:48:53
 */
class CompetitionReadingChallengeRefusedQuestionnaireNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_READING_CHALLENGE_REFUSED_QUESTIONNAIRE';
     ...
     */
    public function __construct(ContainerInterface $container, $bookId, $questionnaireId, $groupId = null)
    {
        parent::__construct();
    ...
    public static function translate(Notification $notification, $objects)
    {
        ...
        $questionnaire = MediaQuery::create()->findPk($objects['questionnaireId']);
        ...
        if ($book->getAuthorizeQuestionnaires()) {
            $finalObjects['%secondSentence%'] = parent::$container->get('translator')->trans('COMPETITION_READING_CHALLENGE_REFUSED_QUESTIONNAIRE.COMPETITION_REPROPOSE', [], 'COMPETITION_READING_CHALLENGE_REFUSED_QUESTIONNAIRE');
        } else {
