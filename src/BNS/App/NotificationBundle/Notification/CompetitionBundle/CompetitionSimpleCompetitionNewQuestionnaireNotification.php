...
/**
 * Notification generation date : 23/06/2017 15:41:31
 */
class CompetitionSimpleCompetitionNewQuestionnaireNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_SIMPLE_COMPETITION_NEW_QUESTIONNAIRE';
