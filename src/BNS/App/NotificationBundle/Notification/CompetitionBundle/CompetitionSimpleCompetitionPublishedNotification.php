...
/**
 * Notification generation date : 23/06/2017 15:38:15
 */
class CompetitionSimpleCompetitionPublishedNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_SIMPLE_COMPETITION_PUBLISHED';
