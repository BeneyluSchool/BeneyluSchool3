...
/**
 * Notification generation date : 23/06/2017 15:42:16
 */
class CompetitionSimpleCompetitionPublishedWithContributionNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'COMPETITION_SIMPLE_COMPETITION_PUBLISHED_WITH_CONTRIBUTION';
    ...
    public static function translate(Notification $notification, $objects)
    {
        ...
        $finalObjects['%userName%'] = $competition->getUser()->getFullName();
        /*
