...
/**
 * Notification generation date : 24/02/2013 14:35:10
 */
class ForumNewForumReplyNotification extends Notification implements NotificationInterface
{
    const NOTIFICATION_TYPE = 'FORUM_NEW_FORUM_REPLY';
