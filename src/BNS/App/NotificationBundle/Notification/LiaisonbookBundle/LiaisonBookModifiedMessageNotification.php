 ...
 */
class LiaisonBookModifiedMessageNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'LIAISON_BOOK_MODIFIED_MESSAGE';
