...
/**
 * Notification generation date : 22/01/2013 17:02:23
 */
class LiaisonBookNewMessageToSignNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'LIAISON_BOOK_NEW_MESSAGE_TO_SIGN';
