...
/**
 * Notification generation date : 28/01/2013 12:00:57
 */
class MessagingNewAnswerReceivedNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'MESSAGING_NEW_ANSWER_RECEIVED';
