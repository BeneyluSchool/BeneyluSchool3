...
/**
 * Class MinisitePageNewsModifiedNotification
 *
 * @package BNS\App\NotificationBundle\Notification\MiniSiteBundle
 */
class MinisitePageNewsModifiedNotification extends Notification implements NotificationInterface
{

    const NOTIFICATION_TYPE = 'MINISITE_PAGE_NEWS_MODIFIED';
