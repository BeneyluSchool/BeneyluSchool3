...
/**
 * Notification generation date : 28/01/2013 18:36:34 
 */
class ProfileCommentPublishedNotification extends Notification implements NotificationInterface
{
	const NOTIFICATION_TYPE = 'PROFILE_COMMENT_PUBLISHED';
