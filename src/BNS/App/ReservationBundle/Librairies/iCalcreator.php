<?php
/*
 * /!\ Des tweaks ont été réalisé sur ce fichier ! Pour les retrouver, faites une recherche
 * sur ce fichier de la chaîne de caractère suivante : "TWEAK:"
 */

/*
 * -->> Commun à toutes les classes (sauf calendarComponent et iCallUtilityFunctions) <<--
 * 
 * TWEAK: le constructeur de chaque classe portait le nom de la classe (vcalendar(), etc.); j'ai dû renommer
 * tous les constructeurs de toutes les classes du fichier en __construct(), sans quoi le framework considère
 * qu'aucun constructeur n'est spécifié pour chaque classe et initialise toutes les varibles d'instance à null;
*/

// TWEAK: il a fallu spécifier un namespace et la classe DateTimeZone pour que le framework reconnaisse ce fichier
 ...
 */
  function calendarComponent() {
  	...
  	/*
  	 * TWEAK: on ne pouvait pas faire un simple get_class() car on récupère également le namespace;
  	 */
  	
  	$class = explode('\\', get_class($this)); // TWEAK
  	
    $this->objName         = ( isset( $this->timezonetype )) ?
                          strtolower( $this->timezonetype )  :  end($class); // TWEAK
    $this->uid             = array();
    $this->dtstamp         = array();
...
/*********************************************************************************/
/**
 * delete calendar ²nent from component container
 *
 * @author Kjell-Inge Gustafsson, kigkonsult <ical@kigkonsult.se>
 * @since 2.8.8 - 2011-03-15
 * @param mixed $arg1 ordno / component type / component uid
