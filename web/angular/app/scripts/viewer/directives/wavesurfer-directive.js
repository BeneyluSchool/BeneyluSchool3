...
angular.module('bns.viewer.wavesurfer', [])
  ...
  .controller('WavesurferController', function ($scope, $interval) {
    ...
    $scope.$on('wavesurferInit', function (e, wavesurfer) {
      ...
      wavesurfer.on('play', function () {
        $scope.$emit('wavesurfer.play', ctrl.wavesurfer);
      });
    ...
    $scope.$on('wavesurfer.stopOthers', function (event, item) {
      if (ctrl.wavesurfer.isPlaying() && item !== ctrl.wavesurfer) {
