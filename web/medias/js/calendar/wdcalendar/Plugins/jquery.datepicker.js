; (function($) {
    // BNS Tweak
    weekDayTab = ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'];
    ...
    $.fn.datepicker = function(o) {
        ...
        if (cp.length == 0) {
            ...
            for (var i = def.weekStart, j = 0; j < 7; j++) {
                cpHA.push("<th class='", weekDayTab[j] , "'><span>", def.weekName[i], "</span></th>");
                if (i == 6) { i = 0; } else { i++; }
            }
            cpHA.push("</tr></thead>");
            ...
            cpHA.push("<div id='BBIT-DP-MP' class='bbit-dp-mp'  style='z-index:auto;'><table id='BBIT-DP-T'><tbody>");
            cpHA.push("<tr>");
        ...
        function writecb() {
            ...
            // FIXME: commence par lundi et non dimanche
            ...
            for (var i = 1; i <= 42; i++) {
                ...
                tdc.push(weekDayTab[ind++]);
				// TWEAK: condition ... || (ndate.getMonth() == 11 && showmonth == 0) rajouté pour pouvoir ajouter nos classes css nécessaires
				if (ndate.getMonth() < showmonth || (ndate.getMonth() == 11 && showmonth == 0)) {
                ...
                if (dis) {
                    ...
                    tdc.push("bbit-dp-active dp-day-btn");
                }
            ...
            bhm.push("<script type='text/javascript'>" +
            		"$(\".dp-day-btn\").click(function(e) { " +
            		"e.stopPropagation(); " +
            		"updateDateRangeView(new Date($(this).attr('title'))); });" +
            		"</script>");
            tb.html(bhm.join(""));
        }
