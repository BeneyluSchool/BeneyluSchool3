$(document).ready(function() {
	guiders.createGuider({
		...
		description: "<p>Un évènement qui dure toute la journée n'a pas d'heure de début et de fin.</p> <p>Note : les évènements de ce type sont situés dans la partie supérieure du calendrier.</p>",
		id: "first",
		next: "second",
		autoFocus: true,
		position: 7,
		title: "Evènement qui dure toute la journée",
		xButton: true,
		width: 420,
		offset: {
			top: 48,
	...
	guiders.createGuider({
		...
		autoFocus: true,
		position: 11,
		title: 'Créer un évènement récurrent',
		xButton: true,
		width: 420,
		offset: {
			top: 50,
