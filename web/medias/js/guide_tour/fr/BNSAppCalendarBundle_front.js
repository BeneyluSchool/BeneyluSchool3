$(document).ready(function() {
	guiders.createGuider({
		...
		description: "<p>Bienvenue sur le module de calendrier.</p> <p>Ici, vous avez accès à tous vos agendas et les événements liés.</p>",
		id: "first",
		next: "second",
		title: "Le Calendrier",
		xButton: true
	...
	guiders.createGuider({
		...
		buttons: [{name: "Suivant", classString: "btn btn-info btn-small pull-right", onclick: guiders.next}],
		description: "<p>Cliquez sur ce bouton pour voir les événements de la semaine passée ou sur le bouton \"Voir la semaine prochaine\" pour visualiser les événements de la semaine suivante.</p>",
		id: "second",
		next: "third",
		position: 6,
	...
	guiders.createGuider({
		...
		buttons: [{name: "Suivant", classString: "btn btn-info btn-small pull-right", onclick: guiders.next}],
		description: "<p>Masquez ou affichez les événements de l'agenda en cliquant sur l'un de ces boutons.</p>",
		id: "fourth",
		next: "finally",
		position: 3,
	...
	guiders.createGuider({
		...
		description: "<p>Le clic sur un événement vous ménera sur une nouvelle page fournissant des informations supplémentaires.</p>",
		id: "finally",
		position: 6,
